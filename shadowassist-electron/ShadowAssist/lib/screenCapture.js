...
/** Max width for vision payload — modest downscale (slightly smaller / lighter upload). */
const VISION_MAX_W = 1120
/** JPEG 0–100 — light compression; code on screen stays readable. */
const VISION_JPEG_QUALITY = 86
