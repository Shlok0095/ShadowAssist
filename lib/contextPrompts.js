...
const DEFAULT_CONTEXT_PROMPTS = [
  ...
  },
  {
    ...
    name: 'Interview',
    content:
      'I am in a job interview as the interviewee. When a question appears (from audio or screen), give me the DIRECT ANSWER I should speak — in first person, naturally. Do NOT answer as VeilAssist. Do NOT coach from outside or describe the question. Use STAR for behavioral questions (4 sentences max). Keep answers under 120 words. Use my resume and reference files for real experience — never fabricate.',
  },
]
