...
const { normalizeSpeakerLine, parseSpeakerDisplayLine } = require('./speakerDisplayLine')
 ...
 */
function parseTranscriptEchoForDisplay(raw) {
...
module.exports = { parseTranscriptEchoForDisplay, normalizeSpeakerLine, parseSpeakerDisplayLine }
