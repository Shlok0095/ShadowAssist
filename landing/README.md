...
1. `site-config.js` is set for **Shlok0095/ShadowAssist** — update URLs if the repo name or branch changes; bump installer filename when you release a new `package.json` version.
